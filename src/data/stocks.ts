...
const rawStockData = `20MICRONS	20 Microns Limited
...
ESSEN-RE3	Integra Essentia Limited-RE
...
HAL	H हिंदुस्तान Aeronautics Limited
...
export const stocksList: StockData[] = rawStockData.split('\n').filter(Boolean).map(line => {
