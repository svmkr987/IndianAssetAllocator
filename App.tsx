            ...
            <div id="report-content" className="space-y-12 bg-white p-6 sm:p-12 rounded-[2.5rem] shadow-inner border border-slate-100">
              ...
              <div className="pt-8 border-t border-slate-100 text-center flex flex-col items-center gap-1.5">
                ...
                <p className="text-slate-400 text-[10px] font-medium tracking-wider">
                  Find out which ones: <a href="https://wa.me/919008264816?text=Hi" target="_blank" rel="noopener noreferrer" className="text-amber-500 font-bold ml-1" >+91-9008264816</a> (Only Whatsapp). To learn Swing trading, click <a href="https://t.me/svmkr_alerts" target="_blank" rel="noopener noreferrer" className="text-amber-500 font-bold ml-1" >SVMKR Signal Hub</a>.
                </p>
              </div>
            </div>
